...
mocha_1.describe('Users', function () {
    beforeEach(function (done) {
        user_1.default.remove({}, function (err) {
            done();
        });
    });
    mocha_1.describe('Backend tests for users', function () {
        mocha_1.it('should get all the users', function (done) {
        ...
        mocha_1.it('should get users count', function (done) {
            chai.request(app_1.app)
                .get('/api/users/count')
                .end(function (err, res) {
                res.should.have.status(200);
        ...
        mocha_1.it('should create new user', function (done) {
        ...
        mocha_1.it('should get a user by its id', function (done) {
        ...
        mocha_1.it('should update a user by its id', function (done) {
            var user = new user_1.default({ username: 'User', email: 'user@example.com', role: 'user' });
            user.save(function (error, newUser) {
                chai.request(app_1.app)
        ...
        mocha_1.it('should delete a user by its id', function (done) {
            var user = new user_1.default({ username: 'User', email: 'user@example.com', role: 'user' });
            user.save(function (error, newUser) {
                chai.request(app_1.app)
